...
class CustomUserRegisterView(generics.CreateAPIView):
    ...
    @extend_schema(
        operation_id='Create a User using OTP verificatio',
        description='This endpoint Create a User using OTP verificatio',
        summary='This endpoint is used to Create a User using OTP verificatio',
        request= OpenApiTypes.OBJECT,
    ...
    def perform_create(self, serializer):
        ...
        return Response({'success': _('User has been created')}, status=status.HTTP_200_OK)
...
class SendOTPView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({'success': _('OTP has been sent.')}, status=status.HTTP_200_OK)
